...
layui.define(['jquery', 'layer', 'form', 'laytpl', 'element', 'table', 'neat', 'neatDataApi', 'waterDeviceDataApi', 'neatNavigator', 'commonDataApi', 'neatValidators'], function (exports) {
    ...
    "use strict";
    var $ = layui.$;
    var MODULE_NAME = "pageNEATWaterGatewayUpdate";
    ...
    SubPage.prototype.initSave = function () {
        ...
        form.on('submit(btnSave)', function (formData) {
            ...
            var data = {
                ...
                entId: that.detailObj[dataPropertyNames.enterpriseId],
                domainId: that.detailObj[dataPropertyNames.domainId],
            ...
            pageDataApi.updateNEATWaterGateway(token, data
                , function (sd) {
