...
layui.define(["jquery", 'element', 'form', 'table', 'laytpl', 'laypage','layer', 'neat', 'neatNavigator', 'commonDataApi', 'enterpriseDataApi', 'pageBoard'], function (exports) {
...
mobilePhone 
    ...
    SubPage.prototype._initAddEvent = function () {
        ...
        $('#btnAdd').on('click', function () {
            ...
            var url = "/pages/foundationInfo/enterprise/enterpriseCreate.html?parentId=" + treeData.domainId
    ...
    SubPage.prototype._initTableOperateColEvent = function () {
        ...
        table.on('tool(resultTable)', function (obj) {
            ...
            if (obj.event === 'del') {
                ...
                var url = "/pages/foundationInfo/enterprise/enterpriseUpdate.html?id=" + data.id
    ...
    exports("pageEnterpriseList", new SubPage());
