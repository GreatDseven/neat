...
layui.define(['jquery', 'layer', 'form', 'laydate', 'laytpl', 'upload', 'neat', 'neatDataApi', 'neatDataApi', 'neatNavigator', 'commonDataApi', 'keypartDataApi',  "neatValidators"], function (exports) {

    "use strict";

    var MODULE_NAME = "pageKeypartCreate";
    ...
    SubPage.prototype._initFormSubmit = function () {
        ...
        form.on('submit(btnSave)', function (formData) {
            ...
            pageDataApi.createKeypart(token, postData
                , function (sd) {//成功
    ...
    //初始化建筑
    SubPage.prototype._initOptBuilding = function () {
        var that = this;
        

        pageDataApi.getAllBuildings(neat.getUserToken(), "", that.entId, function (resultData) {
