...
layui.define(["jquery", 'element', 'form','layer', 'laytpl', 'neat', 'neatNavigator', 'commonDataApi', 'imageDataApi', 'treeview', 'neatUITools', 'tooltipster'], function (exports) {
    ...
    var MODULE_NAME = "pagePlanImgLayoutViewByDeviceId";
    ...
    SubPage.prototype.buildTree = function () {
        ...
        // 获取 平面图左侧树
        pageDataApi.getReleatedPlanImgListByDeviceId(token, this.deviceId, function (data) {
    ...
    SubPage.prototype.isCurrentPage = function (deviceId) {
    ...
    SubPage.prototype.addDeviceToImg = function (deviceInfo) {
        ...
        var className = "";
        var isCurrentDevice = this.isCurrentPage(deviceInfo[deviceInfoPropertyNames.deviceId]);
        if (isCurrentDevice) {
            className = "device current-device";
        }
        else {
            className = "device not-current-device";
        }
        ...
        if (this.needShowAll == false && isCurrentDevice == false) {
    ...
    SubPage.prototype.initShowAllChangeEvent = function () {
        ...
        $("#btnShowHidenNormalDevice").on("click", function () {
            ...
            $('.not-current-device').each(function () {
