...
layui.define(["jquery", 'element', 'form', 'table', 'laytpl', 'layer', 'neat', 'neatNavigator', 'commonDataApi'], function (exports) {
    ...
    "use strict";
    var MODULENAME = "pageAdcSelector3rd";
    ...
    var PageAdcSelector = function () {
        ...
        var that = this;
        that.zipcode = neatNavigator.getUrlParam("zipcode");
    ...
    PageAdcSelector.prototype.initData = function () {
        var that = this;
        commonDataApi.getADCList3rd(that.zipcode, neat.getUserToken(), function (resultData) {
    ...
    //
    PageAdcSelector.prototype.init = function (zipcode) {
